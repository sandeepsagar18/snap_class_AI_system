...
export default function TeacherDashboard() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel rounded-2xl px-6 py-4 border border-slate-200 bg-white/90 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Automated facial recognition & student lecture registration QR.
          </p>
        </div>
